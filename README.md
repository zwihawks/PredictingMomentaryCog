...
5. Data (analyzed using code in 3 and 4) + results associated with conditional models that included careless and missing responses among between-person predictors (Secondary_analysis.zip).  
