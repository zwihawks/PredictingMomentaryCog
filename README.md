...
5. Data (analyzed using code in 3 and 4, above) + results associated with models that included careless and missing responses among between-person predictors (Secondary_analysis.zip).  
