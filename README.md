...
5. Data for and results from secondary analyses that re-estimated conditional models with counts of careless and missing responses among between-person predictors (Secondary_analysis.zip). Data were analyzed using code in (3) and (4), above.  
